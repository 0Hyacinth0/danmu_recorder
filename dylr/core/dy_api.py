...
from dylr.core.room_info_base import RoomInfo
...
def get_api_url(room_id):
    ...
    # return ('https://live.douyin.com/webcast/room/web/enter/?aid=6383&app_name=douyin_web&live_id=1&'
    #         'device_platform=web&language=zh-CN&enter_from=page_refresh&cookie_enabled=true&screen_width=1920'
    #         '&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name='
    #         f'Chrome&browser_version=122.0.0.0&web_rid={room_id}&'
    #         'room_id_str=7382779339466689318&enter_source=&is_need_double_stream=false&insert_task_id='
    #         '&live_reason=&msToken=_8kZvHuJwhGexbK9r1Zz_4RHB1jmJuq6q99N3yhRjsIKtyvmUfBfAGvXWrQCpo1ND'
    #         's1Jb_7PzXNA5ytOIgBaTj7eEodbr06zBlBK0kuR3a-Z8iQ8u9bzHw%3D%3D&a_bogus=QXWh%2Fm0XmEfBvDWD5-nL'
    #         'fY3q66l3Y89T0tLVMD2fvVfZWy39HMYh9exoPbhvKbDjNs%2FDIeEjy4hbOp%2FdrQIH8Hwf7Wkw%2F2CZsgv0t-P2'
    #         'so0j53intL6mE0hN5kb3SFlm5XNAEOJ0y75rzbz0A2n7mhK4bfebY7Y6i6trzf%3D%3D')
...
def get_danmu_ws_url(room_id, live_room_real_id, retry=0):
    ...
    json_data = {
        'room_id': str(live_room_real_id),
    }
    url2 = 'http://106.54.228.32:1234/get_dy_signature'
    response = requests.post(url2, headers=headers, json=json_data).json()
    print(response)
    sig=response['signature']
    kkk=f'wss://webcast5-ws-web-lq.douyin.com/webcast/im/push/v2/?app_name=douyin_web&version_code=180800&webcast_sdk_version=1.0.12&update_version_code=1.0.12&compress=gzip&device_platform=web&cookie_enabled=true&screen_width=2056&screen_height=1329&browser_language=zh-CN&browser_platform=MacIntel&browser_name=Mozilla&browser_version=5.0%20(Macintosh;%20Intel%20Mac%20OS%20X%2010_15_7)%20AppleWebKit/537.36%20(KHTML,%20like%20Gecko)%20Chrome/124.0.0.0%20Safari/537.36&browser_online=true&tz_name=Asia/Shanghai&cursor=t-1715564536381_r-1_d-1_u-1_fh-7368292528464516132&internal_ext=internal_src:dim|wss_push_room_id:7368225756100479763|wss_push_did:7313435273566897690|first_req_ms:1715564536301|fetch_time:1715564536381|seq:1|wss_info:0-1715564536381-0-0|wrds_v:7368293567707482253&host=https://live.douyin.com&aid=6383&live_id=1&did_rule=3&endpoint=live_pc&support_wrds=1&user_unique_id=7313435273566897690&im_path=/webcast/im/fetch/&identity=audience&need_persist_msg_count=15&insert_task_id=&live_reason=&room_id={live_room_real_id}&heartbeatDuration=0&signature=' +sig

    # uniqueId=''
    # ab = execjs.compile(open('signature.js','r',encoding='utf-8').read()).call("getSign",room_id, uniqueId)['X-Bogus']
    # print(ab)
